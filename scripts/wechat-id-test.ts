...
ok('should not treat name with phone as session id', !isSessionIdLike('莒县何乃迎塑料厂13963331631'))
ok('should not treat chinese+english mixed remark as session id', !isSessionIdLike('26.7.20 @果思园食品 王保坤13922252918'))
ok('should not treat name with underscore-space as session id', !isSessionIdLike('高俊达 金福祥机电 19506826888'))
