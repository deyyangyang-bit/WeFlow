...
- **下一阶段**：候选方向 = P0-3 E3 CustomerEvent（扩展 intent_tag_log，复用 12h 节流）/ P0-4 Action 埋点（北极星「有效销售行动」六段漏斗前置）/ 判断生产覆盖提升观察——**选择权交回用户**。
