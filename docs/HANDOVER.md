...
- **E3.2 待定**（最小生产者接入：customer_replied / quote_asked，最接近现有真实事实链）；**E3.3 待定**（action events：script_copied / chat_opened / follow_up_done，P0-4 前置）
