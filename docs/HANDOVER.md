...
- **下一刀**：**P0-2 UI 迁移**（AI 当前判断卡消费 `currentView.judgments`；360 判断卡从现场 advice 改消费 currentView；SalesContextStrip/今日行动/收件箱迁移）——Current View 已验收通过，可进入。
